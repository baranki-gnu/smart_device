...
/* harmony import */ var _modules_modals_modal_window__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modals/modal-window */ "./js/modules/modals/modal-window.js");
/* harmony import */ var _utils_scroll_to_form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/scroll-to-form */ "./js/utils/scroll-to-form.js");
/* harmony import */ var _utils_show_more_less__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/show-more-less */ "./js/utils/show-more-less.js");
/* harmony import */ var _utils_telephone_mask__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/telephone-mask */ "./js/utils/telephone-mask.js");
/* harmony import */ var _utils_form_validation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/form-validation */ "./js/utils/form-validation.js");
/* harmony import */ var _utils_form_general__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils/form-general */ "./js/utils/form-general.js");
...
window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // ---------------------------------
  Object(_utils_menu_toggle__WEBPACK_IMPORTED_MODULE_2__["toggleMenu"])(_utils_menu_toggle__WEBPACK_IMPORTED_MODULE_2__["dataItems"]);
  Object(_utils_scroll_to_form__WEBPACK_IMPORTED_MODULE_4__["scrollToForm"])();
  Object(_utils_show_more_less__WEBPACK_IMPORTED_MODULE_5__["showMoreLess"])();
  Object(_utils_form_general__WEBPACK_IMPORTED_MODULE_8__["startStoringData"])();
  Object(_utils_form_validation__WEBPACK_IMPORTED_MODULE_7__["enableSubmit"])(_utils_telephone_mask__WEBPACK_IMPORTED_MODULE_6__["feedbackForm"], _utils_telephone_mask__WEBPACK_IMPORTED_MODULE_6__["feedbackMask"]);
  Object(_utils_form_validation__WEBPACK_IMPORTED_MODULE_7__["enableSubmit"])(_utils_telephone_mask__WEBPACK_IMPORTED_MODULE_6__["modalForm"], _utils_telephone_mask__WEBPACK_IMPORTED_MODULE_6__["modalMask"]);
  Object(_utils_ios_vh_fix__WEBPACK_IMPORTED_MODULE_0__["iosVhFix"])();

  // Modules
  // ---------------------------------
  Object(_modules_modals_modal_window__WEBPACK_IMPORTED_MODULE_3__["callModalFunctions"])();
...
/***/ "./js/modules/modals/modal-window.js":
/*!*******************************************!*\
  !*** ./js/modules/modals/modal-window.js ***!
  \*******************************************/
/*! exports provided: callModalFunctions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "callModalFunctions", function() { return callModalFunctions; });
/* harmony import */ var _utils_modal_focus_trap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/modal-focus-trap */ "./js/utils/modal-focus-trap.js");

var openModalButton = document.querySelector('[data-open-modal]');
var closeModalButton = document.querySelector('[data-close-modal]');
var modalOverlay = document.querySelector('[data-modal="feedback-call"]');
var bodyBlock = document.querySelector('[data-body]');
function lockScroll() {
  if (bodyBlock) {
...
function openModal() {
  if (modalOverlay) {
    ...
    lockScroll();
    var inputName = modalOverlay.querySelector('[data-name-input] input');
    if (inputName) {
      inputName.focus();
    }
    Object(_utils_modal_focus_trap__WEBPACK_IMPORTED_MODULE_0__["trapModalFocus"])(modalOverlay);
...
function closeModal() {
  if (modalOverlay && modalOverlay.classList.contains('is-open')) {
    ...
    unlockScroll();
    Object(_utils_modal_focus_trap__WEBPACK_IMPORTED_MODULE_0__["trapModalFocus"])(modalOverlay).onClose();
...
var formMain = document.querySelector('[data-feedback-form]');
var formModal = document.querySelector('[data-form-modal]');
...
function storeFormData(formBlock) {
  if (formBlock) {
    ...
    var userQuest = formBlock.querySelector('[data-textarea] textarea');
    var userQuestKey = 'user-question';
...
/*!*************************************!*\
  !*** ./js/utils/form-validation.js ***!
  \*************************************/
/*! exports provided: enableSubmit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "enableSubmit", function() { return enableSubmit; });
function validateTel(formBlock) {
  var inputField = formBlock.querySelector('[data-telephone-input] input');
  if (inputField) {
...
function validateName(formBlock) {
  var inputField = formBlock.querySelector('[data-name-input] input');
  if (inputField) {
    if (inputField.value) {
      return true;
    }
...
function enableSubmit(formBlock, phoneMask) {
  if (formBlock) {
    var submitButton = formBlock.querySelector('[data-send-button]');
    var nameValidationTip = formBlock.querySelector('[data-name-warning]');
    var telephoneValidationTip = formBlock.querySelector('[data-telephone-warning]');
    submitButton.addEventListener('click', function () {
      phoneMask.updateValue();
      var checkName = validateName(formBlock);
      var checkTelephone = validateTel(formBlock, phoneMask);
...
/*!*********************************!*\
  !*** ./js/utils/menu-toggle.js ***!
  \*********************************/
/*! exports provided: toggleMenu, dataItems */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var dataItems = document.querySelectorAll('[data-footer-item]');
function checkAndCloseItems(dataList) {
  dataList.forEach(function (item) {
    if (item.classList.contains('is-open')) {
      var toggleButton = item.querySelector('[data-toggle]');
...
function toggleMenu(dataList) {
  dataList.forEach(function (item) {
    ...
    var toggleButton = item.querySelector('[data-toggle]');
    var toggleWrap = item.querySelector('[data-toggle-wrap]');
    toggleWrap.addEventListener('click', function (evt) {
      evt.preventDefault();
...
/***/ "./js/utils/modal-focus-trap.js":
/*!**************************************!*\
  !*** ./js/utils/modal-focus-trap.js ***!
  \**************************************/
/*! exports provided: trapModalFocus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "trapModalFocus", function() { return trapModalFocus; });
function trapModalFocus(item) {
...
var scrollTrigger = document.querySelector('[data-form-scroll]');
var feedbackForm = document.querySelector('[data-feedback-form]');
function scrollToForm() {
  if (scrollTrigger && feedbackForm) {
    scrollTrigger.addEventListener('click', function (evt) {
      evt.preventDefault();
...
/***/ "./js/utils/show-more-less.js":
/*!************************************!*\
  !*** ./js/utils/show-more-less.js ***!
  \************************************/
/*! exports provided: showMoreLess */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showMoreLess", function() { return showMoreLess; });
var buttonTextToggle = document.querySelector('[data-show-more-less]');
var extraText = document.querySelector('[data-extra-text]');
var lessText = document.querySelector('[data-less-text]');
...
function showMoreLess() {
  if (checkAvailability()) {
    ...
    buttonTextToggle.addEventListener('click', function (evt) {
      evt.preventDefault();
...
/***/ "./js/utils/telephone-mask.js":
/*!************************************!*\
  !*** ./js/utils/telephone-mask.js ***!
  \************************************/
/*! exports provided: feedbackForm, feedbackMask, modalForm, modalMask */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "feedbackForm", function() { return feedbackForm; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "feedbackMask", function() { return feedbackMask; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "modalForm", function() { return modalForm; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "modalMask", function() { return modalMask; });
/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! imask */ "../node_modules/imask/esm/index.js");

var modalForm = document.querySelector('[data-modal]');
var feedbackForm = document.querySelector('[data-feedback-form]');
function createMask(formBlock) {
  if (formBlock) {
    var inputField = formBlock.querySelector('[data-telephone-input] input');
    if (inputField) {
      var phoneMask = new imask__WEBPACK_IMPORTED_MODULE_0__["default"](inputField, {
...
var feedbackMask = createMask(feedbackForm);
var modalMask = createMask(modalForm);
